                  ...
                  >
                    ...
                    <div className="flex gap-3 w-full sm:w-auto">
                      <button
                        ...
                        className="flex-1 sm:flex-none px-6 py-3 border border-gray-200 text-gray-500 font-medium rounded-full transition-all hover:bg-gray-50 cursor-pointer"
                      >
                        Decline
                      </button>
                      <button
                  ...
                  >
                    ...
                    <div className="mt-auto border-t border-gray-100 pt-4 flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-white border border-gray-200 text-gray-500 hover:text-gray-900 hover:border-gray-400 text-xs font-bold rounded-lg transition-all"
                      >
                        View File
                      </button>
                    </div>
